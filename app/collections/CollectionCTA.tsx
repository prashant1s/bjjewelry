...
export function CustomDesignCTA() {
  return (
    <section className="relative py-24 h-[350px] border-b border-[#f2d98a]/50  overflow-hidden bg-[#1a1a1a]">
      ...
      {/* Gold glow beneath button */}
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[360px] h-[160px] bg-[#C9A84C]/15 blur-[70px] rounded-full" />
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-4 text-center">
        ...
        >
          We offer custom design services to bring your vision to life
        </motion.p>
