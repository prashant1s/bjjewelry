...
//   // 4. Construct a BULLETPROOF Sanity GROQ Query
//   // We start the query block
//   let query = `*[_type == "product"`;
//   const queryParams: Record<string, any> = {};

//   // CATEGORY: We use 'match' instead of '==' so it becomes case-insensitive! 
//   // (e.g., 'Bangles' in Sanity will match 'bangles' from the URL)
//   if (resolvedParams.slug !== "new-arrivals") {
