...
//             {/* Main Big Image */}
//             <div className="relative aspect-square w-full bg-[#f8f8f8] border border-gray-100 rounded-sm overflow-hidden">
//               {activeImage ? (
...
//                     className={`relative aspect-square border-2 transition-all duration-200 overflow-hidden ${
//                       activeImage === img ? "border-[#C9A84C]" : "border-transparent hover:border-[#f2d98a]"
//                     }`}
//                   >
