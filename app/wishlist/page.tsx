          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
              {wishlist.map((product) => {
                // Safely extract ID for the React key
                const productId = product._id || product.id;

                return (
                  <div key={productId} className="group relative border border-gray-100 rounded-lg overflow-hidden hover:shadow-xl transition-shadow bg-white">
