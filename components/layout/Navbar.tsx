        ...
        <div className="flex items-center justify-between h-20 md:h-24">
          ...
          <Link href="/" className="flex items-center md:mt-2 gap-2 lg:gap-4">
            ...
            <div className="flex flex-col items-start justify-center">
              <span
                className="text-lg md:text-xl lg:text-2xl font-light tracking-[0.2em] lg:tracking-[0.3em] uppercase"
              ...
              <span className="hidden lg:block text-[9px] tracking-[0.25em] uppercase mt-1" style={{ color: GOLD }}>
