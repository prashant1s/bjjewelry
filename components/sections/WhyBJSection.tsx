...
// import { ShieldCheck, Award, Gem, Truck, Headphones, Package } from "lucide-react";
...
//               className="flex gap-5 p-6 group"
//             >
//               <div className="flex-shrink-0 w-12 h-12 border border-[#f2d98a] flex items-center justify-center group-hover:border-[#C9A84C] group-hover:bg-[#fdf8ec] transition-all">
...
//                   {feature.title}
//                 </h3>
//                 <p className="text-[#6a6a6a] text-sm leading-relaxed">{feature.desc}</p>
//               </div>
//             </motion.div>
//           ))}
//         </div>
